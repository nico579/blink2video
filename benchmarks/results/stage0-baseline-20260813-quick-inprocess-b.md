# Campagne interne provisoire B — étape 0
...
Date : 2026-08-13T17:01:15+02:00
Profil : `quick`
...
| P-02 | measured | real_json_io | 2.677 ms | oui |
| P-03 | measured | real_json_io | 78.877 ms | oui |
| P-04 | measured | real_state_and_files | 85.466 ms | non |
| P-05 | measured | real_matching_synthetic_dataset | 48.035 ms | oui |
| P-06 | measured | real_parser_fake_blink_no_network | 1.424 ms | oui |
| P-07 | measured | real_loopback_http | 6.996 ms | oui |
| P-08 | not_run | excluded_by_operator | — | n/a |
| P-09 | measured | real_orchestrator_fake_io | 93.850 ms | oui |
| P-10 | measured | real_file_io_fake_tokens | 0.837 ms | oui |
