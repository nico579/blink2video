# Campagne interne provisoire A — étape 0
...
Date : 2026-08-13T17:00:51+02:00
Profil : `quick`
...
| P-02 | measured | real_json_io | 3.415 ms | oui |
| P-03 | measured | real_json_io | 140.296 ms | oui |
| P-04 | measured | real_state_and_files | 87.811 ms | non |
| P-05 | measured | real_matching_synthetic_dataset | 45.069 ms | oui |
| P-06 | measured | real_parser_fake_blink_no_network | 2.187 ms | oui |
| P-07 | measured | real_loopback_http | 7.438 ms | oui |
| P-08 | not_run | excluded_by_operator | — | n/a |
| P-09 | measured | real_orchestrator_fake_io | 94.395 ms | oui |
| P-10 | measured | real_file_io_fake_tokens | 0.852 ms | non |
