...
- **Desactiver le telechargement automatique** (garder juste le direct).
  Source : u/daxxruckus, r/blinkcameras, 2026-08-19. Aujourd'hui aucun
...
- **Integration Home Assistant native.** Source : u/MoneySquare6212,
  r/blinkcameras, 2026-08-19. Ecarte pour l'instant (repondu sur Reddit) :
  un vrai chantier a part (config flow, modele d'entites, HACS), pas une
  extension de ce qui existe. Note ici pour ne pas l'oublier si la demande
  revient.
